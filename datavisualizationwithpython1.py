...
ax01 = fig.add_subplot(111, frameon = False)
ax01.set_xticks([])
ax01.set_yticks([])
ax01.set_title("Box and Line Plots of Immigrants from Pakistan, the USA, and India (1980 - 2013)")

ax0 = fig.add_subplot(121) # add subplot 1 (2nd row, 1st columns, first plot)
ax1 = fig.add_subplot(122) # add subplot 2 (2nd row, 1st columns, second plot). 

# Subplot 1: Box plot
df_PUI.plot(kind='box', color='green', vert=False, figsize=(20, 6), ax=ax0) # add to subplot 1
#ax0.set_title('Box Plot of Immigrants from Pakistan, the USA, and India (1980 - 2013)')
